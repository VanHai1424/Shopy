                                    ...
                                    <div>
                                        ...
                                        <div class="form-check form-switch form-switch-success">
                                            <input class="form-check-input" name="status" type="checkbox" role="switch"
                                                id="SwitchCheck3" {{$product->status == 1 ? "checked" : ""}}>
                                        </div>
                                    </div>
                                    @error('status')
                                        <p class="text-danger mt-2">{{ $message }}</p>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        @foreach ($sizes as $size)
                                            ...
                                            <?php
                                                $variant = $variants->first(function($variant) use ($size, $color) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" type="text" name="variant[{{$size->id . '-' . $color->id}}][quantity]" id="" value="{{ $variant ? $variant->quantity : '' }}">
                                                </td>
                                                <td>
