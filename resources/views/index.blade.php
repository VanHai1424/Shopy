                ...
                <ul class="nav nav-tabs nav-fill lavalamp" id="component-1" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#component-1-1" role="tab"
                            aria-controls="component-1-1" aria-selected="true">Women</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#component-1-2" role="tab"
                            aria-controls="component-1-2" aria-selected="false">Men</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#component-1-3" role="tab"
                            aria-controls="component-1-3" aria-selected="false">Kids</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row gutter-1">
                ...
                <div class="card card-tile">
                    ...
                    <div class="card-footer p-lg-5">
                        <div class="bg-white d-inline-block p-3">
                            <h2 class="card-title"><span class="d-block text-gray">Bold & Modern</span> Summer Looks
                            </h2>
            ...
            <div class="col-md-6">
                <div class="card card-tile">
                    ...
                    <div class="card-footer p-lg-5">
                        <div class="bg-white d-inline-block p-3">
                            <h2 class="card-title"><span class="d-block text-gray">Feel the summer</span> Tennis Look
                            </h2>
                            <a href="#" class="underlined">Shop Now</a>
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                <div class="card card-product">
                    <figure class="card-image">
                        ...
                        <a href="#!">
                            <img src="assets/images/demo/product-6.jpg" alt="Image">
                            <img src="assets/images/demo/product-6-1.jpg" alt="Image">
                        </a>
                        <span class="badge badge-success">New</span>
                    </figure>
                    <div class="card-footer">
