            ...
            <div class="row gutter-3 gutter-lg-1">
                ...
                <div class="col">
                    <div class="bg-white cart-item-list p-2 p-lg-3 mb-1">
                                            ...
                                            <div class="col-md-6">
                                                <ul class="list list--horizontal">
                                                    ...
                                                    <li>
                                                        <div class="dropdown">
                                                            <a class="dropdown-toggle" href="#!" role="button"
                                                                id="dropdown-6" data-toggle="dropdown"
                        ...
                        <div class="cart-item">
                            <a href="#!" class="cart-item-image"><img src="assets/images/demo/product-5.jpg"
                                    alt="Image"></a>
                            <div class="cart-item-body">
                                <div class="row">
                                    <div class="col-10">
                                            ...
                                            <div class="col-md-6">
                                                <ul class="list list--horizontal">
                                                    <li class="mr-2">
                                                        <div class="dropdown">
                                                            <a class="dropdown-toggle" href="#!" role="button"
                                                                id="dropdown-8" data-toggle="dropdown"
                                                                aria-haspopup="true" aria-expanded="false">
                                                                Size <span>M</span>
                                                            </a>
                                                    ...
                                                    <li>
                                                        <div class="dropdown">
                                                            <a class="dropdown-toggle" href="#!" role="button"
                                                                id="dropdown-9" data-toggle="dropdown"
                                                                aria-haspopup="true" aria-expanded="false">
                                                                QTY <span>1</span>
                                                            </a>
