            ...
            <div class="row gutter-1">
                ...
                <div class="col">
                    ...
                    <div class="bg-white p-2 p-lg-3 mb-1">
                        <div class="row gutter-1 align-items-center">
                            ...
                            <div class="col-md-6 text-md-right">
                                <a class="underline" data-toggle="modal" data-target="#adresses"><i class="icon-home"></i>
                                    Saved addresses</a>
                            </div>
                        </div>
                        ...
                        <fieldset class="mb-2">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-label-group">
                                        <input type="text" id="inputName2" class="form-control form-control-lg"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-label-group">
                                        <input type="text" id="inputSurname2" class="form-control form-control-lg"
                        ...
                        <fieldset class="mb-2">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-label-group">
                                        <input type="text" id="inputApt" class="form-control form-control-lg"
                                            placeholder="Apt, Suite, etc. (optional)" required="">
                        ...
                        <fieldset class="mb-2">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-label-group">
                                        <input type="text" id="inputCity" class="form-control form-control-lg"
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="select-frame">
                                        <select class="custom-select custom-select-lg" id="customSelect1"
                                ...
                                <div class="col-6">
                                    <div class="form-label-group">
                                        <input type="text" id="inputZip" class="form-control form-control-lg"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="select-frame">
                                        <select class="custom-select custom-select-lg" id="customSelect3"
                    ...
                    <div class="bg-white p-2 p-lg-3 mb-1">
                        ...
                        <div class="custom-control custom-choice">
                            ...
                            <label class="custom-control-label text-dark d-flex justify-content-between align-items-center"
                                for="custom-choice-1">
                                <span>
                    ...
                    <div class="bg-white p-2 p-lg-3 mb-1">
                        ...
                        <fieldset class="mb-3">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-label-group">
                                        <input type="text" id="inputCardNumber" class="form-control form-control-lg"
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-label-group">
                                        <input type="text" id="inputExpiryDate" class="form-control form-control-lg"
                                ...
                                <div class="col-6">
                                    <div class="form-label-group">
                                        <input type="text" id="inputCvv" class="form-control form-control-lg"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-label-group">
                                        <input type="text" id="inputCardName" class="form-control form-control-lg"
                    ...
                    <div class="bg-white p-2 p-md-3">
                        ...
                        <small class="text-muted">By placing your order you agree to our <a href="#">Terms &
                                Conditions</a>, privacy and returns policies. You also consent to some of your data being
                            stored by SHOPY, which may be used to make future shopping experiences better for you.</small>
                    </div>
                ...
                <aside class="col-lg-5">
                    <div class="bg-white p-2 p-lg-3">
                        ...
                        <div class="cart-item">
                            <a href="#!" class="cart-item-image"><img src="assets/images/demo/product-1.jpg"
                                    alt="Image"></a>
                        ...
                        <div class="cart-item">
                            <a href="#!" class="cart-item-image"><img src="assets/images/demo/product-3.jpg"
                                    alt="Image"></a>
                            <div class="cart-item-body">
                                <div class="row">
                                    <div class="col-9">
